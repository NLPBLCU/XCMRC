...
from BiDAF_Cloze.evaluator import Evaluator
from BiDAF_Cloze.graph_handler import GraphHandler
from BiDAF_Cloze.trainer import Trainer
from BiDAF_Cloze.m_prepro import build_dict, prepro_each,vectorize,gen_examples
from BiDAF_Cloze.model import BaselineModel
...
def _train(config):
    ...
    processed_dev_f = os.path.join('/data/private/dyn/MRC/data/CrossTest', "processed",'cloze' , config.version, 'dev.json')
    processed_test_f = os.path.join('/data/private/dyn/MRC/data/CrossTest', "processed",'cloze', config.version, 'test.json')
