...
from model_doc_bert.main import main as m
import pdb
...
flags.DEFINE_string("log_path", "train.log", "log path [0]")

flags.DEFINE_string("bert_vocab_file", "0", "vocab file for bert [0]")
flags.DEFINE_string("bert_config_file", "0", "bert_config.json")
flags.DEFINE_string("init_checkpoint", "0", "bert_model.ckpt")
...
flags.DEFINE_bool("add_seq2seq_loss", True, "Use wy for loss / eval? [False]")
...
flags.DEFINE_integer("max_p_num", 10, "max number of paragraphs for a passage")
...
flags.DEFINE_integer("highway_layers", 2, "feature nums for cnn")
...
flags.DEFINE_bool("fine_tune", False, "softmax over vocabulary")
flags.DEFINE_integer("boundary", 10, "num sents th [8]")
flags.DEFINE_integer("candidate_nums", 9, "num sents th [8]")
flags.DEFINE_bool("monolingual", False, "monolingual or bilingual")
flags.DEFINE_bool("add_bi_word_loss", False, "monolingual or bilingual")
flags.DEFINE_bool("add_bi_sen_loss", False, "monolingual or bilingual")
flags.DEFINE_string("emb_file", "/home/server3/dyn/data/dim_300/mix_vectors.txt", "trains | test | forward [test]")

flags.DEFINE_integer("gpu_id", 0, "word count th [100]")
