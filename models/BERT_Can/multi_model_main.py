...
from model_doc_bert.trainer import Trainer,MultiGPUTrainer
...
def _train(config):
    ...
    trainer = MultiGPUTrainer(config, models, word_2_id_dict)
    ...
    for epoch in range(config.epochs):
        ...
        for batches in gen_examples(train_data, config.batch_size):
            ...
            loss, summary, train_op = trainer.step(sess, batches)
            losses.append(loss)
        import pdb
